        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm mb-4">
              Soluções completas em energia com grupos geradores. Locação, venda, manutenção e projetos.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="hover:text-accent transition-colors cursor-pointer">Venda de Geradores</li>

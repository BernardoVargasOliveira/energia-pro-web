...
const WhyChooseSection = () => {
  ...
  return (
    <section className="py-28 bg-gradient-to-b from-secondary/5 via-primary/5 to-background relative overflow-hidden">
      {/* Decorativos */}
      <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-accent to-transparent" aria-hidden="true" />
      <div className="absolute -top-40 -right-40 w-80 h-80 bg-accent/10 rounded-full blur-3xl" aria-hidden="true" />
      <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-secondary/10 rounded-full blur-3xl" aria-hidden="true" />

      <div className="container mx-auto px-4 relative z-10">
        {/* Card premium branco */}
        <div className="bg-gradient-card rounded-3xl shadow-elevated border-0 p-6 sm:p-10 md:p-16 relative overflow-hidden">
          {/* Barra de acento no topo */}
          <div className="absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r from-primary via-secondary to-accent" aria-hidden="true" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            >
              ...
              <div className="flex items-center gap-4 mb-8">
                ...
                <span className="text-accent text-xs font-bold uppercase tracking-[0.2em]">Diferenciais</span>
              </div>

              <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold mb-8 leading-tight">
              ...
              <div className="space-y-4">
                {differentials.map((item, index) => (
                  ...
                  >
                    ...
                    <span className="text-foreground font-semibold text-base group-hover:text-secondary transition-colors duration-200">
                      {item}
                    </span>
                  </motion.div>
                ))}
              ...
              {metrics.map((metric, index) => (
                ...
                >
                  <Card className="p-8 text-center shadow-card hover:shadow-elevated hover:-translate-y-2 transition-[transform,box-shadow] duration-300 border-0 h-full bg-gradient-card rounded-2xl group overflow-hidden relative">
                    ...
                    />
                    <div
                      className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${metric.gradient} flex items-center justify-center mx-auto mb-4 text-white group-hover:scale-110 transition-transform duration-300`}
                    >
                      {metric.icon}
                    </div>
          ...
          >
            <div className="relative rounded-2xl overflow-hidden shadow-elevated group">
              ...
              />
              {/* Overlay texto */}
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-primary/95 via-primary/60 to-transparent p-6">
                <h3 className="text-primary-foreground font-bold text-xl mb-1">
                  Nosso Galpão de Geradores
                </h3>
                <p className="text-primary-foreground/90 text-sm">
                  Equipamentos prontos para atender sua demanda energética
                </p>
              </div>
            </div>
          </motion.div>
